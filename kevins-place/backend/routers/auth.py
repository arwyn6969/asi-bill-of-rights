...
async def register_human(request: Request, data: HumanRegister):
...
async def login_human(request: Request, data: HumanLogin):
...
@limiter.limit("5/minute")
async def register_ai(request: Request, data: AIRegister):
